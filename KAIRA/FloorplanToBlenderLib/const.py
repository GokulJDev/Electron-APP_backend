...
DEFAULT_IMAGE_PATH = "KAIRA/Images/uploads/1738901959518-example.png"
...
# Paths to models
DOOR_MODEL = "KAIRA/Images/Models/Doors/door.png"
DOOR_MODELS = [
    "KAIRA/Images/Models/Doors/door1.png",  # Door model 1
    "KAIRA/Images/Models/Doors/door2.png",  # Door model 2
    "KAIRA/Images/Models/Doors/door3.png",  # Door model 3
]
DOOR_WIDTH = 5

WINDOW_MODELS = [
    "KAIRA/Images/Models/Windows/window1.png",  # Window model 1
    "KAIRA/Images/Models/Windows/window2.png",  # Window model 2
    "KAIRA/Images/Models/Windows/window3.png",  # Window model 3
    "KAIRA/Images/Models/Windows/window4.png",  # Window model 4
]
...
WALL_FILTER_DISTANCE_THRESHOLD = [0.2, 1.0]
...
DEFAULT_CALIBRATION_IMAGE_PATH = "KAIARA/Images/Calibrations/wallcalibration.png"
